...
export interface TriggerRetrieveResponse {
    log: TriggerRetrieveResponse.Log;
}
export declare namespace TriggerRetrieveResponse {
    interface Log {
        id: string;
        appName: string;
        clientId: string;
...
export declare namespace Triggers {
    export { type TriggerRetrieveResponse as TriggerRetrieveResponse, type TriggerListResponse as TriggerListResponse, type TriggerListParams as TriggerListParams, };
}
