...
class Mcp extends resource_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/api/v3.1/mcp/${id}`, options);
    }
    /**
    ...
    update(id, body = {}, options) {
        return this._client.patch((0, path_1.path) `/api/v3.1/mcp/${id}`, { body, ...options });
    }
    /**
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/api/v3.1/mcp/${id}`, options);
    }
    /**
    ...
    retrieveApp(appKey, query = {}, options) {
        return this._client.get((0, path_1.path) `/api/v3.1/mcp/app/${appKey}`, { query, ...options });
    }
}
exports.Mcp = Mcp;
