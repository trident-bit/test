...
class Files extends resource_1.APIResource {
     ...
     * ```
     */
    list(mountID, params, options) {
        const { session_id, ...query } = params;
        return this._client.get((0, path_1.path) `/api/v3.1/tool_router/session/${session_id}/mounts/${mountID}/items`, {
            query,
            ...options,
        });
    }
     ...
     * ```
     */
    delete(mountID, params, options) {
        const { session_id, ...body } = params;
        return this._client.post((0, path_1.path) `/api/v3.1/tool_router/session/${session_id}/mounts/${mountID}/delete`, {
            body,
            ...options,
        });
    }
     ...
     * ```
     */
    createDownloadURL(mountID, params, options) {
        const { session_id, ...body } = params;
        return this._client.post((0, path_1.path) `/api/v3.1/tool_router/session/${session_id}/mounts/${mountID}/download_url`, { body, ...options });
    }
    /**
     ...
     * ```
     */
    createUploadURL(mountID, params, options) {
        const { session_id, ...body } = params;
        return this._client.post((0, path_1.path) `/api/v3.1/tool_router/session/${session_id}/mounts/${mountID}/upload_url`, {
            body,
            ...options,
        });
    }
