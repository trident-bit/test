...
export declare class Files extends APIResource {
     ...
     * ```
     */
    delete(mountID: string, params: FileDeleteParams, options?: RequestOptions): APIPromise<FileDeleteResponse>;
    /**
     ...
     * ```
     */
    createDownloadURL(mountID: string, params: FileCreateDownloadURLParams, options?: RequestOptions): APIPromise<FileCreateDownloadURLResponse>;
    /**
     ...
     * ```
     */
    createUploadURL(mountID: string, params: FileCreateUploadURLParams, options?: RequestOptions): APIPromise<FileCreateUploadURLResponse>;
}
...
export declare namespace Files {
    export { type FileListResponse as FileListResponse, type FileDeleteResponse as FileDeleteResponse, type FileCreateDownloadURLResponse as FileCreateDownloadURLResponse, type FileCreateUploadURLResponse as FileCreateUploadURLResponse, type FileListParams as FileListParams, type FileDeleteParams as FileDeleteParams, type FileCreateDownloadURLParams as FileCreateDownloadURLParams, type FileCreateUploadURLParams as FileCreateUploadURLParams, };
}
