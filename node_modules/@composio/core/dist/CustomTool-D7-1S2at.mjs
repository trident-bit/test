import { s as ComposioError$1 } from "./FileModifierErrors-C7z16Dfi.mjs";
import { APIError } from "@composio/client";
import { ZodError, z as z$1 } from "zod/v3";
...
function createCustomTool(slug, options) {
	...
	let outputSchema;
	if (options.outputParams) outputSchema = zodToJsonSchema.default(options.outputParams, { name: "output" }).definitions.output;
	return {
...
//#endregion
export { ComposioMultipleConnectedAccountsError as $, ValidationErrorCodes as A, ComposioGlobalExecuteToolFnNotSetError as B, ComposioWebhookSignatureVerificationError as C, JsonSchemaRefResolutionError as D, SDKErrorCodes as E, ConnectionRequestFailedError as F, ComposioToolNotFoundError as G, ComposioInvalidModifierError as H, ConnectionRequestTimeoutError as I, handleToolExecutionError as J, ComposioToolVersionRequiredError as K, AuthConfigErrorCodes as L, ComposioToolkitNotFoundError as M, ToolkitErrorCodes as N, JsonSchemaToZodError as O, ConnectionRequestErrorCodes as P, ComposioLegacyConnectedAccountsEndpointRetiredError as Q, ComposioAuthConfigNotFoundError as R, ComposioWebhookPayloadError as S, ComposioNoAPIKeyError as T, ComposioProviderNotDefinedError as U, ComposioInvalidExecuteFunctionError as V, ComposioToolExecutionError as W, ComposioConnectedAccountNotFoundError as X, ComposioAclOnlyForSharedError as Y, ComposioFailedToCreateConnectedAccountLink as Z, ComposioFailedToCreatePusherClientError as _, createCustomToolkit as a, ComposioFailedToUnsubscribeFromPusherChannelError as b, getPreloadedCustomToolSlugs as c, CreateCustomToolBaseSchema as d, ComposioSharedAccessDeniedError as et, CreateCustomToolkitBaseSchema as f, RemoteFileErrorCodes as g, RemoteFileDownloadError as h, createCustomTool as i, ComposioToolkitFetchError as j, ValidationError as k, serializeCustomToolkits as l, PRELOAD_TOOLS_ALL as m, buildCustomToolsMap as n, ConnectedAccountErrorCodes as nt, findCustomToolMapEntryByFinalSlug as o, CustomToolSlugSchema as p, ToolErrorCodes as q, buildCustomToolsMapFromResponse as r, findCustomToolMapEntryByToolkitAndOriginalSlug as s, assertNoCustomToolSlugsInPreload as t, ComposioSharedConnectionNotAccessibleError as tt, serializeCustomTools as u, ComposioFailedToGetSDKRealtimeCredentialsError as v, TriggerErrorCodes as w, ComposioTriggerTypeNotFoundError as x, ComposioFailedToSubscribeToPusherChannelError as y, ComposioCustomToolsNotInitializedError as z };