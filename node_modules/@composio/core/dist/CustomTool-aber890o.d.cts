import { a as CustomTool, h as CustomToolkit, i as CreateCustomToolkitParams, n as CreateCustomToolParams } from "./customTool.types-BzEWHa0w.cjs";
 ...
 * ```
 */
declare function createCustomTool<T extends z.ZodType>(slug: string, options: CreateCustomToolParams<T>): CustomTool;
/**
