import { D as ToolkitVersionParam, I as ProviderOptions, J as BaseNonAgenticProvider, Kt as McpUrlResponse, L as SessionExecuteMetaModifiers, P as ExecuteToolModifiers, Vt as McpServerGetResponse, Xt as ExecuteToolFnOptions, a as SchemaModifierOptions, b as ToolRetrievalOptions, d as ToolExecuteResponse$1, l as ToolExecuteParams, m as ToolListParams, o as Tool, p as ToolList, q as BaseComposioProvider, s as ToolExecuteMetaParams, v as ToolProxyParams } from "./tool.types-CwbAy9l_.cjs";
import { Cn as UpdateConnectedAccountAclParams, H as ToolRouterCreateSessionConfig, Qt as ConnectedAccountListResponse, Rt as ConnectionRequest, Tn as UpdateConnectedAccountParams, Xt as ConnectedAccountListParams, a as CustomTool, c as CustomToolInputParameter, fn as CreateConnectedAccountLinkOptions, gn as CreateConnectedAccountOptions, h as CustomToolkit, j as Session, l as CustomToolOptions, rn as ConnectedAccountRetrieveResponse, tn as ConnectedAccountRefreshOptions } from "./customTool.types-BzEWHa0w.cjs";
...
declare class Tools<TToolCollection, TTool, TProvider extends BaseComposioProvider<TToolCollection, TTool, unknown>> {
   ...
   * ```
   */
  getRawToolRouterSessionTools(sessionId: string, options?: SchemaModifierOptions): Promise<ToolList>;
  /**
   ...
   * @returns {Promise<ToolExecuteResponse>} The response from the tool execution
   */
  executeSessionTool(toolSlug: string, body: ToolExecuteMetaParams, modifiers?: SessionExecuteMetaModifiers, tool?: Tool, options?: ToolRouterSessionExecuteOptions): Promise<ToolExecuteResponse$1>;
  /**
...
declare class ConnectedAccounts {
   ...
   * ```
   */
  update(nanoid: string, params: UpdateConnectedAccountParams): Promise<ConnectedAccountUpdateStatusResponse>;
}
//#endregion
...
//#endregion
export { WebhookVersions as $, TriggerSubscribeParamSchema as A, ToolkitAuthConfigDetailsSchema as At, VerifyWebhookParamsSchema as B, ToolkitRetrieveCategoriesResponse as Bt, TriggerInstanceUpsertParams as C, ToolKitItem as Ct, TriggerStatusEnum as D, ToolKitMeta as Dt, TriggerInstanceUpsertResponseSchema as E, ToolKitListResponseSchema as Et, TriggersTypeListParamsSchema as F, ToolkitCategory as Ft, WebhookPayloadV1Schema as G, ToolkitSortByEnumSchema as Gt, WebhookPayload as H, ToolkitRetrieveResponse as Ht, TriggersTypeListResponse as I, ToolkitCategorySchema as It, WebhookPayloadV3 as J, WebhookPayloadV2 as K, ToolkitsListParamsSchema as Kt, TriggersTypeListResponseSchema as L, ToolkitListParams as Lt, TriggerType as M, ToolkitAuthFieldSchema as Mt, TriggerTypeSchema as N, ToolkitAuthFieldsResponse as Nt, TriggerStatusType as O, ToolKitMetaSchema as Ot, TriggersTypeListParams as P, ToolkitAuthFieldsResponseSchema as Pt, WebhookVersion as Q, TriggersTypeRetrieveResponse as R, ToolkitMangedByEnum as Rt, TriggerInstanceManageUpdateResponseSchema as S, CreateCustomAuthConfigParamsSchema as St, TriggerInstanceUpsertResponse as T, ToolKitListResponse as Tt, WebhookPayloadSchema as U, ToolkitRetrieveResponseSchema as Ut, VerifyWebhookResult as V, ToolkitRetrieveCategoriesResponseSchema as Vt, WebhookPayloadV1 as W, ToolkitSortByEnum as Wt, WebhookTriggerPayloadV3 as X, WebhookPayloadV3Schema as Y, WebhookTriggerPayloadV3Schema as Z, TriggerInstanceManageDeleteResponse as _, CreateAuthConfigParams as _t, Experimental as a, AuthConfigRetrieveResponse as at, TriggerInstanceManageUpdateParamsSchema as b, CreateAuthConfigResponseSchema as bt, TriggerData as c, AuthConfigType as ct, TriggerInstanceListActiveParams as d, AuthConfigUpdateParamsSchema as dt, AuthConfigCreationToolAccessConfigSchema as et, TriggerInstanceListActiveParamsSchema as f, AuthCustomConfigUpdateParamsSchema as ft, TriggerInstanceListActiveResponseSchema as g, AuthSchemeTypes as gt, TriggerInstanceListActiveResponseItemSchema as h, AuthSchemeType as ht, MCP as i, AuthConfigListResponseSchema as it, TriggerSubscribeParams as j, ToolkitAuthField as jt, TriggerStatuses as k, ToolkitAuthConfigDetails as kt, TriggerEvent as l, AuthConfigTypes as lt, TriggerInstanceListActiveResponseItem as m, AuthSchemeEnum as mt, ComposioConfig as n, AuthConfigListParamsSchema as nt, IncomingTriggerPayload as o, AuthConfigRetrieveResponseSchema as ot, TriggerInstanceListActiveResponse as p, AuthDefaultConfigUpdateParamsSchema as pt, WebhookPayloadV2Schema as q, OpenAIProvider as r, AuthConfigListResponse as rt, IncomingTriggerPayloadSchema as s, AuthConfigToolAccessConfigSchema as st, Composio$1 as t, AuthConfigListParams as tt, TriggerEventData as u, AuthConfigUpdateParams as ut, TriggerInstanceManageDeleteResponseSchema as v, CreateAuthConfigParamsSchema as vt, TriggerInstanceUpsertParamsSchema as w, ToolKitItemSchema as wt, TriggerInstanceManageUpdateResponse as x, CreateComposioManagedAuthConfigParamsSchema as xt, TriggerInstanceManageUpdateParams as y, CreateAuthConfigResponse as yt, VerifyWebhookParams as z, ToolkitMangedByEnumSchema as zt };